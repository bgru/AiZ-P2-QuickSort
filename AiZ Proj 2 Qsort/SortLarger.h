...
void SortLarger (std::ofstream& Wyniki, int medianNumbers) {
    ...
    Wyniki << "\nResults for case: numbers larger than tab size\n";
    cout << "Sorting with LargerSort with " << medianNumbers << " medianNumbers\n";

    for (int i = 10000; i <= 1000000; i += 10000) {
        cout << "The tab size is: " << i ;
        Wyniki<< i << " ";

        uniform_int_distribution<int> dist{ i + 1, 10000000 };
        ...
        if (medianNumbers > 0) {
        // Quick Sort Median
        cout << "\nSorting with Median and using " << medianNumbers << " as MedianNumbers\n";
